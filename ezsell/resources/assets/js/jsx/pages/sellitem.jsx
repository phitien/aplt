			...
			return (
				...
				onValidSubmit={this.submit}  onValid={this.enableButton} onInvalid={this.disableButton}>
					...
					<div className="row">
						...
						<FormView.Input type='number' name='originalprice' title={localization.original_price} 
							className='col-xs-6 col-md-2' step='0.1' min='0' placeholder='1.0' />
						<FormView.Input type='number' name='nowprice' title={localization.now_price} 
							className='col-xs-6 col-md-2' step='0.1' min='0' placeholder='1.0' />
					</div>
					...
					<FormView.Input type='submit' name='btn-submit' disabled={!this.state.canSubmit} value={localization.sell} className='btn-fixed-right' />
