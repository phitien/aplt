...
var SellItemPage = React.createClass({
	...
	render() {
		...
		return (
			<Form className={className} method='post' action='/sellitem' encType='multipart/form-data'
			onValidSubmit={this.submit}  onValid={this.enableButton} onInvalid={this.disableButton}>
				...
				<div className="row">
					...
					<Input type='number' name='originalprice' title={localization.original_price} 
						className='col-xs-6 col-md-2' step='0.1' min='0' placeholder='1.0' />
					<Input type='number' name='nowprice' title={localization.now_price} 
						className='col-xs-6 col-md-2' step='0.1' min='0' placeholder='1.0' />
				</div>
				...
				<Input type='submit' name='btn-submit' disabled={!this.state.canSubmit} value={localization.sell} className='btn-fixed-right' />
...
export default window.SellItemPage;