...
var BuyItemPage = React.createClass({
	...
	render() {
		...
		return (
			<Form className={this.className('', 'form row')} method='post' action='/buyitem' encType='multipart/form-data'
				...
				<div className="row">
					...
					<Input type='number' name='originalprice' title={configurations.localization.min_price} 
						className='col-xs-6 col-md-2' step='0.1' min='0' placeholder='1.0' />
					<Input type='number' name='nowprice' title={configurations.localization.max_price}
						className='col-xs-6 col-md-2' step='0.1' min='0' placeholder='1.0' />
				</div>
				...
				<Input type='submit' name='btn-submit' disabled={!this.state.canSubmit} value={configurations.localization.buy} className='btn-fixed-right' />
