...
class Item extends Model {
	...
	public function images() {
		return $this->hasMany ( 'App\Platform\Models\Image', 'parent_id', 'id' );
	}
	public function comments() {
		return $this->hasMany ( 'App\Platform\Models\Comment', 'parent_id', 'id' );
	}
	public function likes() {
		return $this->hasMany ( 'App\Platform\Models\Like', 'parent_id', 'id' );
	}
	public function prices() {
		return $this->hasMany ( 'App\Platform\Models\Price', 'parent_id', 'id' );
	}
