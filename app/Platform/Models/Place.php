...
class Place extends Model {
	...
	public function location() {
		return $this->hasOne ( 'App\Platform\Models\Location', 'id', 'id' );
	}
	public function parent() {
		return $this->belongsTo ( 'App\Platform\Models\Place', 'parent_id', 'id' );
	}
	public function children() {
		return $this->hasMany ( 'App\Platform\Models\Place', 'parent_id', 'id' );
	}
